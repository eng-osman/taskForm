...
import { font, width, height } from '../responsive'
...
class FormStep extends Component {
  ...
  renderNextButton = () => {
    ...
    const btnTextStyle = {
      ...
      color: '#fff',
      paddingHorizontal: (this.props.finishBtnText) ? font('40') : font('10'),
  ...
  renderPreviousButton = () => {
    ...
    const btnTextStyle = {
      backgroundColor: (this.props.activeStep) ? '#ddd' : 'transparent',
      color: '#000',
